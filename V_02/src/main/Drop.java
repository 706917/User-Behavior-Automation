...
public class Drop {
	...
	public static void main(String[] args) throws AWTException, IOException, InterruptedException {
		...
		// A Method to run drops
			run(drop_button, scroll, current, ok);
			counter = counter+200;	
		}
	}

	private static void run(int[] drop_button, int[] scroll, int[] current, int[] ok) throws InterruptedException, AWTException {
