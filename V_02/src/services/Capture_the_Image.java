...
public class Capture_the_Image {
	...
	public static void main(String[] args) throws InterruptedException, AWTException, IOException {
		...
		// Put system to sleep to give a time to remove mouse from the area where he
		...
		int imageSize = 20;
		cutImage(coordinates[0], coordinates[1], imageSize, imageSize); // launch the method to capture image using
																		// coordinates identified above and desired
...
//			
	...
	static void cutImage(int xCut, int yCut, int imageWidth, int imageHeight) throws AWTException, IOException {
		...
		String format = "png";
		String fileName = "src/img/ImageToSearch_01." + format;

		/**
		 * Define the rectangle to cut Accepts: - xCut and yCut ______________________
		 * the coordinates of current mouse position - imageWidth, imageHeight _________
		 * the size of rectangle's sides
		 */
